 ...
 */
package com.vimal.helpers.videoview;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private void initControllerView(View v) {
        ...
        if (mCenterPlayButton != null) {
            mCenterPlayButton.setOnClickListener(mPauseListener);
        }
    ...
    public void updatePausePlay() {
        if (mPlayer != null && mPlayer.isPlaying()) {
            mTurnButton.setImageResource(R.drawable.icon_pause);
            mCenterPlayButton.setImageResource(R.drawable.icon_pause);
//            mCenterPlayButton.setVisibility(GONE);
        } else {
            mTurnButton.setImageResource(R.drawable.play);
            mCenterPlayButton.setImageResource(R.drawable.play);
...
//            mCenterPlayButton.setVisibility(VISIBLE);
    ...
    void updateScaleButton() {
        if (mIsFullScreen) {
            ...
            mScaleButton.setImageResource(R.drawable.ic_scale_btn);
        }
    }
